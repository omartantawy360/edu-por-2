    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-slate-500 mt-1">View and manage issued certificates</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredCertificates.map((cert) => (
                    <div key={cert.id} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow">
                        {/* Certificate Preview */}
                        <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-6 border-b-4 border-primary-600">
                            <div className="text-center">
                                <Award className="mx-auto text-primary-600 mb-3" size={40} />
                                <h3 className="font-bold text-slate-800 text-lg mb-1">{cert.achievement}</h3>
                                <p className="text-sm text-slate-600">{cert.competitionName}</p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-xs">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-slate-700">{cert.issuedBy}</p>
                                </div>
                            </div>
                            <div className="pt-2">
