        ...
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-slate-800">Create New Competition</h1>
                        <p className="text-slate-500 mt-1">Design an engaging competition for students</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                    ...
                    <div className="space-y-5">
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 mb-2">Competition Name *</label>
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                rows="4"
                                className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none"
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-slate-800">Competition Details</h2>
                    </div>
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            />
                            <p className="text-xs text-slate-500 mt-1">Optional: Add a cover image to make your competition stand out</p>
                        </div>

                        <div>
                            <label className="block text-sm font-semibold text-slate-700 mb-2">Prize/Rewards</label>
                            <input
                                type="text"
                                name="prize"
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 mb-2">Stages *</label>
                            <input
                                type="text"
                                name="stages"
                                ...
                                required
                            />
                            <p className="text-xs text-slate-500 mt-1">Separate stages with commas</p>
                        </div>
                    </div>
                </div>
